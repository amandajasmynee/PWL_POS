                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-11">
                                <select class="form-control" id="user_id" name="user_id" required>
                                    ...
                                    @foreach ($user as $item)
                                        <option {{ $item->user_id == $transaksi->user_id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ $transaksi->pembeli }}" type="text" name="pembeli" id="pembeli" class="form-control"
                                required>
                            <small id="error-pembeli" class="error-text form-text text-danger"></small>
                        </div>
                        <div class="form-group">
                            <label>Kode Penjualan</label>
                            <input type="text" name="transaksi_kode" id="transaksi_kode" class="form-control" placeholder="{{ $transaksi->transaksi_kode }}">
                            <small id="error-transaksi_kode" class="error-text form-text text-danger"></small>
                        </div>
                        <div class="form-group">
                            <label>Tanggal Penjualan</label>
                            <input value="{{ $transaksi->transaksi_tanggal }}" type="date" name="transaksi_tanggal" id="transaksi_tanggal" class="form-control"
                                required>
